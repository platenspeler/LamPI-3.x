...
T = short period of ~260탎. However, this code tries
...
void NewRemoteReceiver::interruptHandler() {
        ...
        if (_state == -1) {
                ...
                // By default 1T is 260탎, but for maximum compatibility go as low as 120탎
                if (duration > 4800) { // =40*120탎, minimal time between two edges before decoding starts.
