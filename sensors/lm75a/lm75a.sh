...
value=`sudo i2cget -y 1 0x48 0x00 w` 
if [ "$?" != "0" ]; then
	echo "ERROR"
	exit -1
fi
...
$EXEDIR/cmd-sensor -d -h $HOSTNAME -p $PORTNUMBER -b "{\"tcnt\":\"48\",\"action\":\"sensor\",\"brand\":\"lm75\",\"type\":\"json\",\"address\":\"48\",\"channel\":\"0\",\"temperature\":\"$temperature\"}"
